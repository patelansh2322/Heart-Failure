...
class Model:
    ...
    def build_and_evaluate_model(X_train, y_train, X_test, y_test):
        ...
        for name, model in classifiers.items():
            ...
            report_train, f1_train, recall_train, acc_train = Model.model_accuracy(y_train, y_train_pred)
            report_test, f1_test, recall_test, acc_test = Model.model_accuracy(y_test, y_test_pred)
